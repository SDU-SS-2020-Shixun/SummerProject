...
MAX_CAPTCHA = 4
file_dir = 'D:/python program/VOC2007/CroppedVoc/'
...
def get_captcha_text_and_image(filepath):
    ...
    index_2 = random.randint(0, len(file_list_2) - 1)
    filename_2 = file_list_2[index_2]
    file_path_2 = os.path.join(file_path, filename_2)
